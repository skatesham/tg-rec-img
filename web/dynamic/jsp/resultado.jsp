    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <%Imagem padrao = (Imagem) request.getAttribute("padrao");%>

                <div class="container">
                    <div class="row">
                        <h1 class="text-success  text-center w-100 ">Resultado de Reconhecimento</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">Correlação</th>
                                        <td><%=String.format("%.2f", r.getResultado())%></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Chance de acerto</th>
                                        <td><%=String.format("%.0f", (r.getResultado()) * 100)%> %</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Local (X,Y)</th>
                                        <td>(<%=r.getX()%>,<%=r.getY()%>)</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <form method="post" action="${pageContext.request.contextPath}/SalvarResultado">
                                        <input class="btn btn-warning" type="submit" value="Salvar Resultado">
                                        <input name="isMulti" value="false" hidden="true">
                ...
                <% Imagem graficoX = (Imagem) request.getAttribute("graficoX"); %>
                <% Imagem graficoY = (Imagem) request.getAttribute("graficoY");%>
                </br>
                <div class="row">
                    <div class="col-md-6 text-center">
                        <div class="w-100">
                            <img height=auto width=auto  src="<%=graficoX.getStringBase64()%>">
                        </div>
                    </div>
                    <div class="col-md-6 text-center">
                        <div class="w-100">
                            <img height=auto width=auto src="<%=graficoY.getStringBase64()%>">
                        </div>
                    </div>
