...
<html lang="en">
    ...
    <%Galeria galeria = (Galeria) request.getAttribute("padroes");%>
    <%Imagem selected = (Imagem) request.getAttribute("imagem");%>
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <div class="row text-center">
                        <h1 class="text-primary w-100">Reconhecimento de Imagem</h1>
                    </div>
                    <div class="row">

                        <div class="col-md-4 text-center">
                            <h3 class="text-success">Imagem Selecionada</h3>
                            <div class="w-100">
                                <figure class="imghvr-fade ">
                                    <img src="<%=selected.getStringBase64()%>" height="200" width="200" class="img-responsive  img-thumbnail">
                                    <figcaption>
                                        <b>Selecionada:</b>
                                        <p><%=selected.getNome()%></p>
                                        <p>Tamanho: <%=selected.getTamanho()%></p>
                                        <div class="btn-group">
                                            <form method="post" action="${pageContext.request.contextPath}/Galeria">
                                                <input type="submit" value="Trocar de Imagem" class="btn btn-success w-100">
                                            </form>
                                ...
                                <div class="text-center">
                                    <form method="post" action="${pageContext.request.contextPath}/Info">
                                        <input name="imagem_id" value="<%=selected.getId()%>" hidden="true">
                    ...
                    <h2 class="text-danger text-center">Selecione o Padrão</h2>
                    <div class="w-100"></div>
                    <div class="row">
                            ...
                            <div class="w-100">
                                <figure class="imghvr-fade">
                                    ...
                                    <figcaption>
                                        ...
                                        <div class="btn-group">
                                            <form method="post" action="${pageContext.request.contextPath}/ResultadoNumeros">
                                                <input type="submit" value="Reconhecer" class="btn btn-danger w-100">
                                                <input name="padrao_id" value="<%=count%>" hidden="true">
                                                <input name="imagem_id" value="<%=selected.getId()%>" hidden="true">
                                            </form>
                                            <!--button type="button" class="btn btn-success w-100" >Mais Informação</button-->
                                            <!--button type="button" class="btn btn-default">Samsung</button-->
