            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <div class="row text-center">
                        <h1 class="text-success w-100 ">Resultado de Reconhecimento</h1>
                    </div>

                    <div class="row">

                        <%List<ListaResultados> resultados = (List<ListaResultados>) request.getAttribute("resultados");%>
                        <%Imagem img = (Imagem) request.getAttribute("imagem");%>
                        <%Imagem padrao = (Imagem) request.getAttribute("imgPadrao");%>
                        ...
                        <div class="col-md-4 text-center">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <%    int count = 1;%>
                                    <%    for (ListaResultados r : resultados) {%>
                                    <tr>
                                        <th scope="row"><%=count%></th>
                                        <td><%=r.getStringResultado()%></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th scope="row"></th>
                                        <td>Nenhum resultado reconhecido</td>
                                    </tr>
                                    <%
                                        }
                                    %>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="w-50">
                            <form method="post" action="${pageContext.request.contextPath}/DetalhesNumeros">
                        ...
                        <div class="w-25">
                            <form method="post" action="${pageContext.request.contextPath}/SalvarResultado">
                                ...
                                <input name="isMulti" value="true" hidden="true">
                                <input name="imagem_id" value="<%=img.getId()%>" hidden="true">                            
                            </form>                           
                            </form>
                        </div>
