            ...
            <div class="container-fluid text-center">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" style="display: inline;">
                        <form method="post" action="${pageContext.request.contextPath}/Principal">
                            <button  class="btn btn-link" type="submit">Dashboard</button>
                        </form>
                    </li>
                ...
                <div class="container">
                    <h1 class="text-primary">Informações da Imagem</h2>
                        <div class="row">

                            <%Imagem i = (Imagem) request.getAttribute("imagem");%>
                            <%List<Resultado> resultados = (LinkedList< Resultado>) request.getAttribute("resultados");%>

                            <div class="col-md-4 text-center">
                                <img class="img-responsive img-thumbnail" height="200" width="200" src="<%=i.getStringBase64()%>">
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <div class="alert alert-info">
                                    Selecione para escolher <strong>um padrão</strong> de reconhecimento.
                                    <form method="post" action="${pageContext.request.contextPath}/Reconhecimento">
                                        <input value="<%=i.getId()%>" name="id" hidden="true">
                                        <input class="btn btn-dark" type="submit" value="Selecionar Padrão">
                                    </form>
                                </div>


                                <div class="alert alert-info">
                                    Selecione para escolher um <strong>tipo de padrão número </strong> para reconhecimento.

                                    <form method="post" action="${pageContext.request.contextPath}/ReconhecimentoNumeros">
                                        <input value="<%=i.getId()%>" name="id" hidden="true">
                                        <input class="btn btn-dark" type="submit" value="Selecionar Padrões de Números">
                                    </form>
                        ...
                        <div class="row text-center">
                            <div class="col-sm-4">
                                <form method="post" onsubmit="return confirm('Tem certeza?')" action="${pageContext.request.contextPath}/ExcluirImg">
                                    <input value="<%=i.getId()%>" name="id" hidden="true">
                                    <input type="submit" value="Excluir" class="btn btn-danger"/>
                                </form>
                            </div>
                            <div class="col-sm-4">
                                <form method="post" action="${pageContext.request.contextPath}/VerResultado">
                                    <input class="btn btn-warning" type="submit" value="Ver Resultados">
                                    <input value="<%=i.getId()%>" name="imagem_id" hidden="true">
                                </form> 
                            </div>
                            <div class="col-sm-4">
                                <form method="post" action="${pageContext.request.contextPath}/Galeria">
