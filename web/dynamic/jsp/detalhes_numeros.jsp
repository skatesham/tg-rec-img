            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <div class="row text-center">
                        <h1 class="text-success w-100 ">Detalhes do Resultado</h1>
                    </div>

                    <div class="row">

                        <%ListaResultados resultados = (ListaResultados) request.getAttribute("maiores");%>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=resultado.getX()%></td>
                                        <td><%=resultado.getY()%></td>
                                        <td><%=resultado.getCaractere()%></td>
                    ...
                    <div class="row text-center">
                        <div class="w-25">
                            <button class="btn btn-success" onclick="window.history.back();">Voltar</button>
