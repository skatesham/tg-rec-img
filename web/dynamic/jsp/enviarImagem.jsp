        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Galeria de Imagens">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><button disabled="true" class="btn btn-link text-muted">Enviar Imagem</button></li>
                </ol>
                <div class="container">
                    <div class="row">
                        <h1 class="text-primary  text-center w-100 ">Enviar Imagem</h1>
                    </div>
                    <div class="row ">
                        <%--Material!--%>
                        <div class="w-100 ">
                            <div class="col-md-6 alert alert-info">
                                ...
                                <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/UploadImagem">
                                    <div class="form-group">

                                        <div class="alert alert-success text-center" for="nome">Insira um nome e selecione uma imagem para upload</div>
                                        <input class="form-control" value="" name="nome" id="nome" placeholder="Nome da imagem" title="Insira nome da imagem" required>

                                    </div>
                                    <div class="form-group">

                                        <input class="form-control-file" type="file" name="file" id="file" accept="image/*" title="Insira uma imagem" placeholder="Arquivo Imagem" required>

                                    </div>
                                    <div class="form-group">
                                        <input type="submit" class="btn-dark btn"value="Enviar">
                                        </br>
                                    </div>
                                </form>
                            </div>
