...
<html lang="en">
    ...
    <link href="${pageContext.request.contextPath}/static/css/imagehover.css" rel="stylesheet">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <form method="post" action="${pageContext.request.contextPath}/Principal">
            <button  class="navbar-brand btn btn-link" type="submit">Reconhecimento de Imagem  
            </button>
        </form>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><button disabled="true" class="btn btn-link text-muted">Dashboard</button></li>
            </ol>
            
            
                                   
                        
            <%int nResultados = (int) request.getAttribute("nResultados");%>
            <%int nImagens = (int) request.getAttribute("nImagens");%>
            <%int nPadroes = (int) request.getAttribute("nPadroes"); %>
            <!-- Icon Cards-->
            <div class="row">
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-primary o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5"> <%=nImagens%> Imagens Galeria</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-success o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5"> <%=nPadroes%> Amostra disponiveis</div>
                        </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-danger o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5"><%=nResultados%> Resultados salvos</div>
                        </div>
                    </div>
                </div>
            </div>
